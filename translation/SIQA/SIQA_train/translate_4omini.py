...
jsonl_file_path = "./SIQA_train.jsonl"
json_output_file_path = "./SIQA_train_bengali_gpt4omini.jsonl"
...
def translate_entries(entries, output_dir):
    ...
    # Limit the loop to translate only 'sample_size' entries
...
save_translations_to_jsonl(translated_data, json_output_file_path="./SIQA_train_bengali_gpt4omini.jsonl")

print(f"Translation complete. Translated data saved to ./SIQA_train_bengali_gpt4omini.jsonl.")
