...
jsonl_file_path = "./SIQA_dev.jsonl"
json_output_file_path = "./SIQA_dev_bengali_gpt4omini.jsonl"
...
save_translations_to_jsonl(translated_data, json_output_file_path="./SIQA_dev_bengali_gpt4omini.jsonl")

print(f"Translation complete. Translated data saved to ./SIQA_dev_bengali_gpt4omini.jsonl.")
