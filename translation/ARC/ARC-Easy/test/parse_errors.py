...
def get_original_entry(index,file_path="./arc_easy_test.jsonl"):
    try:
        with open(file_path, "r", encoding="utf-8") as file:
...
def replace_affected_entry(index, fixed_entry,output_file_path="./arc_easy_test_gpt4omini.jsonl"):
    try:
...
def detect_english_entries(file_path="./arc_easy_test_gpt4omini.jsonl", log_file_path="./logs/translation.log"):
